...
export class AutoMigration1772667428009 implements MigrationInterface {
    name = 'AutoMigration1772667428009'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "game_players_player" ADD CONSTRAINT "FK_2a478fe145c2b9091cb964c17b5" FOREIGN KEY ("playerId") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
